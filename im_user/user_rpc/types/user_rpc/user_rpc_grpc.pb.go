...
const (
	...
	Users_UserOlineList_FullMethodName = "/user_rpc.Users/UserOlineList"
)
...
type UsersClient interface {
	...
	UserOlineList(ctx context.Context, in *UserOlineListRequest, opts ...grpc.CallOption) (*UserOlineListResponse, error)
}
...
func (c *usersClient) UserOlineList(ctx context.Context, in *UserOlineListRequest, opts ...grpc.CallOption) (*UserOlineListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserOlineListResponse)
	err := c.cc.Invoke(ctx, Users_UserOlineList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServer interface {
	...
	UserOlineList(context.Context, *UserOlineListRequest) (*UserOlineListResponse, error)
...
func (UnimplementedUsersServer) UserOlineList(context.Context, *UserOlineListRequest) (*UserOlineListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserOlineList not implemented")
}
...
func _Users_UserOlineList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserOlineListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServer).UserOlineList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Users_UserOlineList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).UserOlineList(ctx, req.(*UserOlineListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Users_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UserOlineList",
			Handler:    _Users_UserOlineList_Handler,
		},
	},
