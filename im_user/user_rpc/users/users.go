...
type (
	...
	UserOlineListRequest  = user_rpc.UserOlineListRequest
	UserOlineListResponse = user_rpc.UserOlineListResponse
...
func (m *defaultUsers) UserOlineList(ctx context.Context, in *UserOlineListRequest, opts ...grpc.CallOption) (*UserOlineListResponse, error) {
	client := user_rpc.NewUsersClient(m.cli.Conn())
	return client.UserOlineList(ctx, in, opts...)
}
